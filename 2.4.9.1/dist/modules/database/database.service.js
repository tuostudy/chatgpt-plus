...
`;
            const defaultConfig = [
                { configKey: 'siteName', configVal: 'Chat plus', public: 1, encry: 0 },
                { configKey: 'qqNumber', configVal: '2835809579', public: 1, encry: 0 },
                { configKey: 'vxNumber', configVal: 'hxgsrubxjogxeeag', public: 1, encry: 0 },
                { configKey: 'robotAvatar', configVal: '', public: 1, encry: 0 },
                {
                    configKey: 'userDefautlAvatar',
                    configVal: 'https://yanghanwen-1304673413.cos.ap-shanghai.myqcloud.com/ai/avatar.png',
                    public: 0,
                    encry: 0,
                },
                ...
                { configKey: 'registerVerifyEmailTitle', configVal: 'Chat-plus团队账号验证', public: 0, encry: 0 },
                {
                    configKey: 'registerVerifyEmailDesc',
                    configVal: '欢迎使用Chat-plus Team团队的产品服务,请在五分钟内完成你的账号激活,点击以下按钮激活您的账号，',
                    public: 0,
                    encry: 0,
                },
                { configKey: 'registerVerifyEmailFrom', configVal: 'Chat-plus团队', public: 0, encry: 0 },
                { configKey: 'registerVerifyExpir', configVal: '1800', public: 0, encry: 0 },
                { configKey: 'registerSuccessEmailTitle', configVal: 'Chat-plus团队账号激活成功', public: 0, encry: 0 },
                { configKey: 'registerSuccessEmailTeamName', configVal: 'Chat-plus团队', public: 0, encry: 0 },
                {
                ...
                { configKey: 'registerFailEmailTitle', configVal: 'Chat-plus账号激活失败', public: 0, encry: 0 },
                { configKey: 'registerFailEmailTeamName', configVal: 'Chat-plus团队', public: 0, encry: 0 },
